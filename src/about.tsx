   ...
   export function About() {
     ...
     return (
        ...
        <div className={"flex flex-col items-center hover:bg-black/30  p-5 rounded-xl"}>
          <img  src="/ferreicon.jpg" className="w-32 h-32 mb-4 rounded-full"/>
        ...
        <div className={"flex flex-col items-center  p-5 rounded-xl"}>
          <img  src="/William.jpg" className="w-32 h-32 mb-4 rounded-full"/>
        ...
        <div className={"flex flex-col items-center  p-5 rounded-xl"}>
          <img  src="/pontusicon.png" className="w-32 h-32 mb-4 rounded-full"/>
        ...
        <div className={"flex flex-col items-center p-5 rounded-xl"}>
          <img  src="/axelicon.png" className="w-32 h-32 mb-4 rounded-full"/>
